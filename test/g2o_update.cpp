...
int main( int argc, char** argv )
{
    ...
    for(currIndex = startIndex+1; currIndex < endIndex; currIndex++)
    {
        ...
        if (result.inlPoint < min_inlPoint) //inliers不够，放弃该帧
            continue;
        // 计算运动范围是否太大
...
CHECK_RESULT CompareWithKeyFrame(Frame& frame1, Frame& frame2, g2o::SparseOptimizer& opti, bool is_loops, Camera_Intrinsic_Parameters camera)
{
    ...
    Result_of_PnP result = MatchAndRansac(f1, f2, camera);
